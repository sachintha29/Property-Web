...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/larazillow11/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./var/www/larazillow11/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.http_only','session.same_site','session.partitioned','cors.paths','cors.allowed_methods',
...
'debugbar.queries.explain','listing.index','listing.create',
'listing.store','listing.show','listing.edit','listing.update','listing.destroy',
'storage.local',);
